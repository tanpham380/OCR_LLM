...
from app_utils.ocr_package.model.detection.config import EfficientViTConfig
from app_utils.ocr_package.model.detection.processor import SegformerImageProcessor
