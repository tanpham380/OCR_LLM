...
{{
    ...
    async def _send_message(
        ...
        messages: List[Dict[str, str]] = [
            ...
            {"role": "user", "content": user_context , "image": image}
        ]
...
controoler = LlmController("llama3.2-vision:latest")

system_promt = "You are an advanced AI assistant"
user_context = "Extract Text from Vietnamese Citizen ID Cards (CCCD)"
image = ["2024_01_22_10_28_55_resize.jpg"]
# print(controoler.send_custom_message(custom_prompt=system_promt , custom_context=user_context , custom_image=image))
...
async def main():
    result = await controoler.send_custom_message( custom_context=user_context, custom_image=image)
