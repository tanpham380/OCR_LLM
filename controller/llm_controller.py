...
#         return await self.client.chat(self.model, messages=messages)
    ...
    #             "9. Understand and order Vietnamese administrative units from smallest to largest: Thôn/Làng/Khu phố < Xã/Phường/Thị trấn < Quận/Huyện/Thị xã/Thành phố thuộc tỉnh < Tỉnh/Thành phố trực thuộc trung ương.\n"
