    ...
    def _generate_user_context(self, ocr_results: Dict[str, Any]) -> str:
        try:
            ...
            context = (
                ...
                "13. Do not include any explanations, just return the result in JSON format.\n"
                "14. Prioritize accuracy, spelling corrections, and formatting.\n"
                "15. Ensure all dates are in DD/MM/YYYY format.\n"
                "16. Be mindful of unwanted lines; combine or separate information based on context.\n"
                "17. If information is not available in the QR code, use data from OCR.\n"
                "18. Correct misidentifications of personal names, places, and technical terms.\n"
                "19. Ensure the value for 'sex' is either 'Nam' or 'Nữ'.\n"
                "20. If the address for 'place_of_residence' or 'place_of_origin' is split across multiple lines in the OCR data, recognize that these lines belong together and combine them into a single, complete address.\n"
                "21. Use contextual understanding to determine if adjacent lines are part of the same address or field, especially when they are under headings like 'Nơi thường trú' or 'Place of residence'.\n"
                "22. Ensure that all components of the 'place_of_residence' are included, capturing street address, ward, district, and city/province as applicable.\n"
                "23. Do not change personal names unless you are certain there is a misspelling. If unsure, keep the personal names exactly as they appear in the OCR data.\n\n"
