    ...
    def _generate_user_context(self, ocr_results: Dict[str, Any]) -> str:
        try:
            ...
            context = (
                ...
                "5. For 'fullname', 'place_of_residence', and 'place_of_origin', use Vietnamese diacritical marks from VietOCR, but use data from EasyOCR.\n"
                ...
                "- Understand and arrange the administrative divisions in Vietnam from smallest to largest: Hamlet/Village < Commune/Ward/Town < District/City under province < Province/City under central authority.\n"
